...
<head>
	...
	<title>View Sculptures|Auction House</title>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="sculpturesTable">
										<thead>
										<tr>
											<th>Lot Number</th>
											<th>Artist Name</th>
										...
										<tbody>
										<c:forEach items="${sculpturesList}" var="sculpture">
										<tr>
											<td>${sculpture.getLotNumber()}</td>
											<td>${sculpture.getArtistName()}</td>
											<td>${sculpture.getItemProducedDate()}</td>
											<td>${sculpture.getClassification()}</td>
											<td>${sculpture.getAuctionDate()}</td>
											<td>${sculpture.getEstimated_price()}</td>
											<td>${sculpture.getMaterialUsed()}</td>
											<td>${sculpture.getHeight()}</td>
											<td>${sculpture.getWidth()}</td>
											<td>${sculpture.getLength()}</td>
											<td>${sculpture.getDescription()}</td>
											<td><img alt="img" src="data:image/jpeg;base64,${sculpture.getEncodedImage()}" width="500" height="300"/></td>
