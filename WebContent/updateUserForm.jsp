...
<head>
	...
	<title>Update Users| Auction House</title>
...
<body>
			...
			<li class="parent "><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li><a class="" href="addPhotographicImages.jsp">
						<span class="fa fa-arrow-right">&nbsp;</span>Photographic Images
					</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Auction House Update Users Panel</h1>
			</div>
		</div><!--/.row-->
						...
						<div class="col-md-6">
							<form role="form" action="updateUser" method="POST">
								...
								<div class="form-group">
									...
									<input class="form-control" type="text" name="firstname" value="${userInfo.getFirstname()}" required="required">
								</div>
								<div class="form-group">
									<label>Middlename</label>
									<input class="form-control" type="text" name="middlename" value="${userInfo.getMiddlename()}" required="required">
								</div>
								<div class="form-group">
									<label>Lastname</label>
									<input class="form-control" type="text" name="lastname" value="${userInfo.getLastname()}" required="required">
								</div>
								<div class="form-group">
									<label>Address</label>
									<input class="form-control" type="text" name="address" value="${userInfo.getAddress()}" required="required">
								</div>
								<div class="form-group">
									<label>Username</label>
									<input class="form-control" type="text" name="username" value="${userInfo.getUsername()}" required="required">
								</div>
								<div class="form-group">
									<label>Password</label>
									<input class="form-control" type="password" name="password" value="${userInfo.getPassword()}" required="required">
								</div>
								<div class="form-group">
