...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Auction House Add Sculptures Panel</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Add Sculptures</div>
					<div class="panel-body">
						<div class="col-lg-offset-3 col-lg-6">
							<form role="form" action="addSculpture" method="POST" enctype="multipart/form-data">
