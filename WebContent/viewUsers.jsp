...
<head>
	...
	<title>View Users|Auction House</title>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Auction House View Users Panel</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="usersTable">
										<thead>
										<tr>
											<th>Id</th>
											<th>Firstname</th>
										...
										<tr>
											...
											<td><a href="updateUserForm?id=${user.getId()}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>|<a href="deleteUser?id=${user.getId()}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
										</tr>
										</c:forEach>
										</tbody>
									</table>
