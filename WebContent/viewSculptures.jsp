					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="sculpturesTable">
										...
										<tr>
											...
											<td><a href="updateSculptureForm?id=${sculpture.getLotNumber()}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>|<a href="deleteSculpture?id=${sculpture.getLotNumber()}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
										</tr>
										</c:forEach>
										</tbody>
									</table>
