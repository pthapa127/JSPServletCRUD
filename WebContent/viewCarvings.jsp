					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="carvingsTable">
										...
										<tr>
											...
											<td><a href="updateCarvingForm?id=${carving.getLotNumber()}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>|<a href="deleteCarving?id=${carving.getLotNumber()}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
										</tr>
										</c:forEach>
										</tbody>
									</table>
