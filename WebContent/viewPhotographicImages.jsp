					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="photographicImagesTable">
										...
										<tr>
											...
											<td><a href="updatePhotographicImageForm?id=${pi.getLotNumber()}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>|<a href="deletePhotographicImage?id=${pi.getLotNumber()}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
										</tr>
										</c:forEach>
										</tbody>
									</table>
