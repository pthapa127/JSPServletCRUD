					...
					<div class="panel-body">
									...
									<table width="100%" class="table table-hover table-bordered table-striped" id="drawingsTable">
										...
										<tr>
											...
											<td><a href="updateDrawingForm?id=${drawing.getLotNumber()}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>|<a href="deletedrawing?id=${drawing.getLotNumber()}" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a></td>
										</tr>
										</c:forEach>
										</tbody>
									</table>
